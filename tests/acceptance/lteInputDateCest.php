...
class lteInputDateCest
{
    ...
    public function loadTestPageGerman(AcceptanceTester $I)
    {
        ...
        $I->seeInField('#complaint_date', (new DateTime())->sub(new DateInterval('P1D'))->format('d.m.Y'));
    }
    ...
    {
        $I->fillField('#complaint_date', '-1d');
        $I->pressKey('#complaint_date', WebDriverKeys::TAB);
        $I->seeInField('#complaint_date', (new DateTime())->sub(new DateInterval('P1D'))->format('d.m.Y'));
    }
